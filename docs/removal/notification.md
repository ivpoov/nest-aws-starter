...
Notification/receipt/preference schema, WS gateway, the persist-first dispatcher, and the history API (list/unread-count/mark-read/read-all) — IN_APP only, email digest is PR 5.
