...
- [`notification`](./notification.md) — Notification/receipt/preference schema, WS gateway, and the persist-first dispatcher (IN_APP only — email channel and history API are PR 4/5).
