...
import { LockoutListResponseDto } from '@modules/account-security/dtos/responses/lockout-list-response.dto.js';
...
@AdminScope()
@Controller('admin/account-security/lockouts')
export class AccountSecurityAdminController {
