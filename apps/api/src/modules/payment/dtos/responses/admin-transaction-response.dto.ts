import {
  type AdminTransactionResponseInterface,
...
@Exclude()
export class AdminTransactionResponseDto implements AdminTransactionResponseInterface {
  @ApiProperty({ type: String, example: '01890a5d-ac96-774b-bcce-b302099a8057' })
  @Expose()
  readonly id: string;

  @ApiProperty({ type: String, example: '01890a5d-0000-774b-bcce-b30209990001' })
  @Expose()
